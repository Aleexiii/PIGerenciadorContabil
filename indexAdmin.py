...
def abrir_indexAdmin():
    # Função para abrir a página de cadastro de funcionários
    # ------------------------------------------------------
    def abrir_cadastro_funcionario():
        cadastro_funcionario.abrir_cadastro_funcionario()
    # ------------------------------------------------------

    # Função para abrir a página de visualização de funcionários
    # ----------------------------------------------------------
    def abrir_visualizar_funcionarios():
        visualizar_funcionarios.abrir_visualizar_funcionarios()
    # ----------------------------------------------------------

    # Função para abrir a página de documentos de funcionários
    # --------------------------------------------------------
    def abrir_doc_funcionarios():
        docfuncionarios.abrir_doc_funcionarios()
    ...
    box1 = Frame(indexAdminWindow, bg='#ffffff', bd=5)
    box1.place(relx=0.3, rely=0.5, relwidth=0.3, relheight=0.4, anchor=CENTER)
    box2 = Frame(indexAdminWindow, bg='#ffffff', bd=5)
    box2.place(relx=0.7, rely=0.5, relwidth=0.3, relheight=0.4, anchor=CENTER)
    # -------------------------------
    ...
    box1_label = Label(box1, text="Funcionários", bg='#ffffff', font=('Arial', 20, 'bold'))
    box1_label.pack()
    box1_label.place(relx=0.5, rely=0.02, anchor='n')
    ...
    cadastro_funcionario_button = Button(box1, text="Cadastrar", bg='#ffffff', font=('Arial', 12, 'bold'), command=abrir_cadastro_funcionario)
    cadastro_funcionario_button.pack()
    cadastro_funcionario_button.place(relx=0.5, rely=0.4, anchor=CENTER)

    # Botão de visualização de funcionários
    visualizar_funcionarios_button = Button(box1, text="Visualizar", bg='#ffffff', font=('Arial', 12, 'bold'), command=abrir_visualizar_funcionarios)
    visualizar_funcionarios_button.pack()
    visualizar_funcionarios_button.place(relx=0.5, rely=0.6, anchor=CENTER)

    # Botão de documentos de funcionários
    documentos_funcionarios_button = Button(box1, text="Documentos", bg='#ffffff', font=('Arial', 12, 'bold'), command=abrir_doc_funcionarios)
    documentos_funcionarios_button.pack()
    documentos_funcionarios_button.place(relx=0.5, rely=0.8, anchor=CENTER)
